<template>
  <div class="lost-container">
    ...
    />
    <el-dialog title="遗失详情" :visible.sync="dialogFormVisible" width="80%">
      <div class="detail">
...
import { getLostList } from '@/api/auditT'
export default {
  name: 'Lost',
  ...
  methods: {
    fetchData() {
      ...
      getLostList(this.listQuery).then((response) => {
