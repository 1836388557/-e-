<template>
  <div class="find-container">
    ...
    />
    <el-dialog title="招领详情" :visible.sync="dialogFormVisible" width="80%">
      <div class="detail">
...
import { getFindList } from '@/api/auditT'
export default {
  name: 'Find',
  ...
  methods: {
    fetchData() {
      ...
      getFindList(this.listQuery).then((response) => {
